...
local function set_highlights()
	...
	local default_highlights = {
		...
		Conceal = { bg = "NONE" },
		CurSearch = { fg = palette.base, bg = palette.yellow, blend = 20 },
		...
		IncSearch = { fg = palette.base, bg = palette.green, blend = 20 },
		...
		Tag = { fg = palette.cyan },
		Todo = { fg = palette.orange, bg = palette.orange, blend = 20 },
		...
		["@markup.list.checked"] = { fg = palette.cyan, bg = palette.cyan, blend = 10 },
		...
		--- lazy.nvim
		LazyNormal = { fg = palette.text, bg = palette.surface },
		LazyButton = { fg = palette.text, bg = palette.overlay },
		LazyButtonActive = { fg = palette.base, bg = palette.blue, bold = styles.bold },
		LazyH1 = { fg = palette.base, bg = palette.blue, bold = styles.bold },
		LazyH2 = { fg = palette.text, bold = styles.bold },
		LazyComment = { fg = palette.muted },
		LazyCommit = { fg = palette.green },
		LazyCommitIssue = { fg = palette.blue },
		LazyCommitType = { fg = palette.cyan },
		LazyCommitScope = { fg = palette.purple },
		LazyDimmed = { fg = palette.muted },
		LazyDir = { fg = palette.blue },
		LazyProp = { fg = palette.cyan },
		LazyReasonCmd = { fg = palette.yellow },
		LazyReasonEvent = { fg = palette.orange },
		LazyReasonFt = { fg = palette.purple },
		LazyReasonKeys = { fg = palette.green },
		LazyReasonPlugin = { fg = palette.red },
		LazyReasonRuntime = { fg = palette.brown },
		LazyReasonSource = { fg = palette.cyan },
		LazyReasonStart = { fg = palette.teal },
		LazySpecial = { fg = palette.yellow },
		LazyTaskError = { fg = groups.error },
		LazyTaskOutput = { fg = palette.text },
